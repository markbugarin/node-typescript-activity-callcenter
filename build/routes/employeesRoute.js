...
router.post('/', (request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newDepartment = yield employeesService_1.default.getInstance().save(payload);
...
router.get('/:id', (request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingDepartment = yield employeesService_1.default.getInstance().findById(request.params.id);
